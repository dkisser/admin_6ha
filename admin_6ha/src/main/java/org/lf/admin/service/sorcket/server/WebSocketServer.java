package org.lf.admin.service.sorcket.server;
...
import org.lf.admin.service.sorcket.message.BrowerMsg;
import org.lf.admin.service.sorcket.ws.WebSocketService;
...
public class WebSocketServer {
	...
	public void onOpen (Session session,EndpointConfig config) {
		...
		User user = (User)httpSession.getAttribute(Constants.USER_LOGIN_INFO);
