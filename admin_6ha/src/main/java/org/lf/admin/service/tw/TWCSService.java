...
public class TWCSService {
	 ...
	 */
	public void submitZS (String dm,String czr) throws OperException {
		try{
			//news修改状态
	 ...
	 * @throws OperException 
	 */
	public void revert (String dm,String czr,String remark) throws OperException {
		try{
			//news修改状态
			JNews record = new JNews();
			record.setDm(dm);
			...
			remarkSb.append("提交进行一审，现处于").append(XWZT.一审未通过).append("状态，");
