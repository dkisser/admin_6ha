...
<html>
  ...
  <body>
    ...
    <script type="text/javascript">
   	function visitor(){
   		window.location.href = "${pageContext.servletContext.contextPath}/admin/main.do";
   	}
   	function login(){
		$("#loginForm").form("submit",{
			url: getContextPath() + "/admin/loginAction.do",
			onSubmit: function () {
			...
			success: function (result) {
				...
				if (re.success) {
					...
					window.location.href = "${pageContext.servletContext.contextPath}/admin/loginUI.do";
				}
			},
		});    		
   	}
