...
<html>
  ...
  <body>
   	<div id="dlgUserCMain">
   		  <div id="userC_toolbar" style="height: 30px;width:100%;line-height: 20px;">
   		    ...
   		    <div style="height: 100%;float: right;">
   		      <div>
   		        ...
   		        <div style="float: left;padding-top: 5px;"><input id="txbUserCname" name="uname"/></div>
   		        <div style="float: left;padding-left: 30px;padding-top: 5px;">认证类别：</div>
   		        <div style="float: left;padding-right: 30px;padding-top: 5px;"><input id="cbxUserCstatus" name="status"/></div>
   		      </div>
   		    </div>
   		  </div>
...
<script type="text/javascript">
	...
	$("#txbUserCname").textbox({
		 ...
		 onClickButton: function () {
			var url = getContextPath() + "/admin/system/getUserFuzzy.do?uname="+$("#txbUserCname").textbox("getText")+"&role="+"${role}"+"&status="+$("#cbxUserCstatus").combobox("getValue");
	...
	$("#cbxUserCstatus").combobox({
		...
		onSelect : function (record) {
			var url = getContextPath() + "/admin/system/getUserFuzzy.do?status="+record.id+"&role="+"${role}"+"&uname="+$("#txbUserCname").textbox("getText");
			$("#dgUserCList").datagrid("reload",url);
		},
