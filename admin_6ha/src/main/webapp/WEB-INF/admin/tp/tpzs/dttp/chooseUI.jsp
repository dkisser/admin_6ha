...
<body>
    <div id="dgchooseDttp" fit=true></div>
<script type="text/javascript">
	var chooseDttpUI = {
			
		groundDttp:function (index) {
			var chooseRow = $("#dgchooseDttp").datagrid('getData').rows[index];
			layui.use('layer',function () {
				var layer = layui.layer;
				$.ajax({
					url:getContextPath() + "/admin/tpzs/groundDttpNews.do",
					method:"POST",
					cache:false,
					data:{dm:dttpzsUI_submitZSRow.dm,replaceDm:chooseRow.dm},
					dataType:"json",
					success:function (res) {
						$("#dttpzsUI_newGroundDlg").dialog('close');
	...
	$("#dgchooseDttp").datagrid({
		url:getContextPath() + "/admin/tpzs/chooseDttpList.do",
		queryParams:{lx:dttpzsUI_submitZSRow.lx},
