...
<body>
  <form class="layui-form layui-form-pane" id="previewPttpUI_form" method="post" action="twsj/editDtw.do" enctype="multipart/form-data">
...
<script type="text/javascript">
	...
	var previewPttpUI = {
			...
			cancel: function () {
				$("#pttpcsUI_newPreviewDlg").dialog("close");
			}
		};
</script>
